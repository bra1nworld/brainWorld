...
declare namespace Leaf {
    ...
    interface APIFunction<TOption, TResult> {
        ...
        with(data: Partial<TOption>): APIFunction<TOption, TResult>;
        transform<TModifiedResult>(result: (option: TResult) => TModifiedResult): ({
            (option: TOption, callback: APICallback<TModifiedResult>): void;
        });
    }
    interface APIOption {
    ...
    class APIDeclare<TOption, TResult> {
        ...
        private decorateAPIOption(option, fn);
