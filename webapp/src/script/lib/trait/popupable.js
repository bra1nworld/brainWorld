...
var Popupable = /** @class */ (function () {
    function Popupable(widget, manager) {
        if (manager === void 0) { manager = Popupable.globalManager; }
        this.widget = widget;
        this.manager = manager;
        this.isShow = false;
    }
    Popupable.prototype.show = function () {
        if (this.isShow)
            return;
        this.isShow = true;
    ...
    Popupable.prototype.hide = function () {
    ...
    Popupable.prototype.center = function () {
        if (!this.isShow)
            return null;
    ...
    Popupable.globalManager = new PopupStack();
    return Popupable;
}());
exports.Popupable = Popupable;
