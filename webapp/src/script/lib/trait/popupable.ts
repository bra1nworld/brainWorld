export class PopupStack {
    ...
    public popups: Popupable[] = []
    constructor(public readonly base: number = 10000) {
    }
    public add(p: Popupable): boolean {
    ...
    public remove(p: Popupable): boolean {
        let change = false
...
export class Popupable {
    ...
    constructor(private widget: {
        node: HTMLElement
        asPopup: Popupable
    }, private manager: PopupStack = Popupable.globalManager) {
    }
    public show() {
