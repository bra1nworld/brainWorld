...
export class CheckAnnotatedTaskManager extends R.CheckAnnotatedTask {
    checkAnnotatedTaskList = new AnnotatedTaskList()
    constructor() {
        super()
    }
}

class AnnotatedTaskList extends DataListEditor<SceneAnnotation.AnnotatingTask> {
    url = "checkAnnotatedTask"
    refresh(option: {
