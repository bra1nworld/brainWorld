...
export class MyAnnotatedTaskManager extends R.MyAnnotatedTask {
    myAnnotatedTaskList = new MyAnnotatedTaskList()
    constructor() {
        super()
    }
}

class MyAnnotatedTaskList extends DataListEditor<SceneAnnotation.AnnotatingTask> {
    url = "myAnnotatedTask"
    refresh(option: {
